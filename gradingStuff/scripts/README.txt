GradingScripts
graderSetterUpperM
Requirements: Perl is installed
...
Run the script
What it does: Goes through the class' admin folder looking for the list of students whose assignments are to be graded by you (assigned to your userid), copies down the userids assigned to you and then goes into the .score directory to copy all files that match the patterns given in the @toBeCopied array.
